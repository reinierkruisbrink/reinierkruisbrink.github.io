...
These cross-link Forest notes to relevant entries in the Library:

| Tag | Shared with |
|---|---|
| `botany` | Books on plant science |
| `mycology` | Books on fungi |
| `ecology` | Books on ecology and ecosystems |
| `soil` | Books on soil science |
