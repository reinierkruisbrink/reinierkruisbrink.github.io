...
- **Mycorrhizal networks**: Tree roots form symbiotic associations with mycorrhizal fungi. The fungal hyphae extend far beyond the root zone, connecting individual trees into a shared underground network through which carbon, nitrogen, phosphorus, and water are exchanged.
- **Resource sharing**: "Mother trees" (large, established trees) can subsidize younger or shaded trees through the network, transferring photosynthetically fixed carbon to saplings that would otherwise die from insufficient light. This challenges the view of forests as purely competitive environments.
- **Chemical signaling**: When attacked by herbivores, trees can release volatile organic compounds (VOCs) that travel above ground and through the mycorrhizal network, prompting neighboring trees to preemptively upregulate chemical defenses (e.g., tannins, phenolics).
