...
I found the topic incredibly interesting, especially as a layer on top of the other books I've read, not on the causes but on how to solve the problem of *indefinite* growth. Unfortunately, I felt it was a one sided and even a bit naive to layout the *solution*. I agree with the author though, but it felt like he was preaching to the choir and not really addressing the real world problems of implementing these solutions. I would have liked to see more on how to get people on board with these ideas, and how to make them politically feasible rather than saying "we need to do this and this and this".
